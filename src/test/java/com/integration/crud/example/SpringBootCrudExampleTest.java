...
class SpringBootCrudExampleTest {
    ...
    @Test
    @Sql(statements = "DELETE FROM product WHERE name = 'headset'",executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    ...
    @Test
    @Sql(statements = "INSERT INTO product (id,name, quantity, price) VALUES (1,'CAR', 1, 334000)", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    ...
    @Test
    @Sql(statements = "DELETE FROM product",executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Sql(statements = "INSERT INTO product (id,name, quantity, price) VALUES (8,'books', 5, 1499)", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
